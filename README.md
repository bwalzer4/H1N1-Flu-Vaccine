...
6. The lack of interpretability of MLP models is one of its weaknesses and determining feature importance was proved to be too challenging for this project; therefore, the Neural Network model is excluded from this table. The feature importance for the CatBoost, xgBoost, and Random Forrest algorithms is based on the weighted average of the total decrease in node impurity for each feature based on a Decision Tree Classifier and scaled between 0 and 1.
